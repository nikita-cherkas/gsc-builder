...
// --- Items ---
const allItems = computed<EquipmentItem[]>(() =>
...
<template>
  <ModalWindow
    ...
    size="lg"
    hide-close
    container-class="equipment-popup-override"
          ...
          <section class="equipment-popup__left">
            <nav class="equipment-popup__tabs-nav">
              <button
                ...
                :key="tab.key"
                type="button"
                class="equipment-popup__tab-btn"
          ...
          <aside class="equipment-popup__right">
            ...
            <ul class="equipment-popup__list">
              ...
              <li
                ...
                :key="item.id"
                class="equipment-popup__item-wrapper"
                :class="{ 'is-active': item.id === selectedEquipment.id }"
              >
                <button
                  type="button"
                  class="equipment-popup__item"
                  :class="{ 'is-active': item.id === selectedEquipment.id }"
                ...
                >
                  ...
                  <div class="item-info">
                    ...
                    <span v-if="item.attributes?.Drawers" class="item-subtext">
        ...
        <footer class="equipment-popup__footer">
          <div class="footer-content">
            <div class="selection-summary">
              ...
              <span class="value">
                {{
                  selectedEquipment.attributes?.Option || selectedEquipment.name
                }}
              </span>
              <span
