...
export const CUTOUT_OPTIONS: CutoutData[] = [
  {
    ...
    label: "Solid top",
    description:
      "No cutouts. Maximum work surface for pop-ups, markets, events.",
  ...
  },
  {
    ...
    label: "With sink",
    description:
      "Adds an inset hand sink — required for most health-code permits.",
  ...
  },
  {
    ...
    label: "Full service",
    description:
      "Everything plus 8 oz & 12 oz cup dispensers. Full barista setup.",
  ...
  },
  {
    ...
    label: "Compact pro",
    description:
      "Service plus cup dispensers, no sink. For permitted commissary use.",
